...
默认每个namespace一个cache对象，如果要多个namespace公用一个的话，可以使用<cache-ref>标签。
...
对于粗粒度的查询源码，以上就分析完了。要深入的话，可以继续看TransactionalCacheManager的源码。

TODO TransactionalCacheManager源码。 具体的Cache实现类的源码
